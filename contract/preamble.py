...
def _reference_bodies() -> dict[str, str]:
    ...
    if mode == "db":
        ...
        try:
            with open_store() as store:
                for key in store.document_keys(NAME, scopes):
